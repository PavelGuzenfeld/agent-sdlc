...
`ListAgents`, its Subagents section only — a peer or remote session listed there is
foreign, same as another terminal's work, and is never checkpointed, named "not
touched" in the report at most. Nothing live: skip to survey.
